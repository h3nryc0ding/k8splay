...
<div
	class="container relative grid h-[calc(100vh-var(--navbar-height))] flex-col items-center justify-center lg:max-w-none lg:grid-cols-2 lg:px-0"
>
	...
	<div class="lg:p-8">
		<div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
			<div class="flex flex-col space-y-2 text-center">
				...
				<p class="text-sm text-muted-foreground">Enter your credentials below to sign in</p>
			</div>
