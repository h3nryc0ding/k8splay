...
dependencies {
    ...
    // Misc
    implementation("com.netflix.graphql.dgs:graphql-dgs-spring-boot-starter:8.2.0")
    runtimeOnly("com.netflix.graphql.dgs:graphql-dgs-subscriptions-websockets-autoconfigure:8.2.0")
}
